...
public class PatchedServerGamePacketListener {
   ...
   public static void handleInteract(ServerboundInteractPacketWrapper interactPacket, PacketListenerPlayIn listener) {
      if (listener instanceof PlayerConnection) {
         ...
         PlayerConnectionUtils.a(interactPacket, connection, connection.p().z());
         ...
         if (!player.eY()) {
            ...
            if (entity != player || player.P_()) {
               ...
               if (entity == null) {
               ...
               } else if (serverLevel.D_().a(entity.dm())) {
                  ...
                  if (!(boundingBox.e(player.br()) >= PlayerConnection.d)) {
                     interactPacket.a(new c() {
                        private void performInteraction(EnumHand enumhand, PatchedServerGamePacketListener.EntityInteraction entityInteraction, PlayerInteractEntityEvent event) {
                           ...
                           if (itemstack.a(serverLevel.I())) {
                              ...
                              if (triggerLeashUpdate && (event.isCancelled() || player.fS().f().d() != origItem)) {
                                 connection.b(new PacketPlayOutAttachEntity(entity, ((EntityInsentient)entity).fT()));
                              }
                              ...
                              if (event.isCancelled() || player.fS().f().d() != origItem) {
                                 ...
                                 if (entity instanceof Allay) {
                                    ...
                                    connection.b(new PacketPlayOutEntityEquipment(entity.aj(), (List)Arrays.stream(EnumItemSlot.values()).map((slot) -> {
                        ...
                        public void a() {
                           if (!(entity instanceof EntityItem) && !(entity instanceof EntityExperienceOrb) && !(entity instanceof EntityArrow) && (entity != player || player.P_())) {
   ...
   public static void handleUseItem(PacketPlayInBlockPlace packet, PacketListenerPlayIn listener, Consumer<EnumInteractionResult> afterUse) {
      if (listener instanceof PlayerConnection) {
         ...
         PlayerConnectionUtils.a(packet, connection, player.z());
         if (!player.eY()) {
            ...
            if (shouldLimit) {
               ...
               if (!itemstack.b() && itemstack.a(worldserver.I())) {
                  ...
                  MovingObjectPosition movingobjectposition = player.dM().a(new RayTrace(vec3d, vec3d1, BlockCollisionOption.b, FluidCollisionOption.a, player));
                  boolean cancelled;
