      ...
      this.models.forEach((modelId, modelData) -> {
         ...
         if (activeModel != null) {
            ...
            modelData.defaultStates.forEach((modelState, property) -> {
               activeModel.getAnimationHandler().setDefaultProperty(new AnimationHandler.DefaultProperty(modelState, property.stateId, property.lerpIn, property.lerpOut, property.speed));
            });
